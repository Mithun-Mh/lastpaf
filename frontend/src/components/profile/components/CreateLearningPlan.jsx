import React, { useState, useEffect } from 'react';          //submit function line 248   //post mapping line 260
...
const CreateFitnessSchedule = () => {
  ...
  const validateForm = () => {                                  //form validation
    ...
    } else if (formData.title.length < 3) {                           // Check if the title is shorter than 3 characters.
